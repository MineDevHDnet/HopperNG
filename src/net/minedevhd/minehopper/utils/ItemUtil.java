...
public class ItemUtil {
     ...
     * Displayname
     */
    public ItemUtil(Material material, int amount, String displayname) {
        if (material == null) {
            material = Material.AIR;
        }
     ...
     */
    public ItemUtil(Material material, String displayname) {
        if (material == null) {
            material = Material.AIR;
        }
        Validate.notNull(displayname, "The displayname is null.");
     ...
     */
    public ItemUtil(FileConfiguration cfg, String path) {
     ...
     */
    @Deprecated
    public ItemUtil(ItemUtil builder) {
     ...
     */
    @Deprecated
    public ItemUtil damage(short damage) {
        this.damage = damage;
        return this;
    }
    
    public ItemUtil skullTexture(String base64) {
        if (material != Material.SKULL_ITEM) return this;
     ...
     * @param damage Damage for the ItemStack
     */
    public ItemUtil durability(short damage) {
        this.damage = damage;
        return this;
    }
     ...
     */
    public ItemUtil meta(ItemMeta meta) {
     ...
     */
    public ItemUtil enchant(Enchantment enchant, int level) {
     ...
     */
    public ItemUtil enchant(Map<Enchantment, Integer> enchantments) {
     ...
     */
    public ItemUtil displayname(String displayname) {
        Validate.notNull(displayname, "The displayname is null.");
     ...
     */
    @Deprecated
    public ItemUtil lores(String... lines) {
     ...
     * @param lines One or more Strings for the ItemStack Lore
     */
    public ItemUtil lore(String... lines) {
        Validate.notNull(lines, "The lines are null.");
        for (String line : lines) {
            lore(andSymbol ? ChatColor.translateAlternateColorCodes('&', line) : line);
        }
     ...
     */
    public ItemUtil lore(String line, int index) {
        Validate.notNull(line, "The line is null.");
    ...
    /**
     * Hides all visible ItemFlags (like attributes, enchants, unbreakable, etc.)
     */
     ...
     */
    public ItemUtil flag(ItemFlag flag) {
     ...
     */
    public ItemUtil flag(List<ItemFlag> flags) {
     ...
     */
    @Deprecated
    public ItemUtil owner(String user) {
     ...
     */
    @Deprecated
    public ItemUtil replaceAndSymbol() {
     ...
     */
    public ItemUtil replaceAndSymbol(boolean replace) {
        andSymbol = replace;
        return this;
    }

    /** Toggles replacement of the '&' Character in Strings */
    public ItemUtil toggleReplaceAndSymbol() {
        replaceAndSymbol(!andSymbol);
        return this;
    }
     ...
     */
    public ItemUtil unsafeStackSize(boolean allow) {
        this.unsafeStackSize = allow;
        return this;
    }

    /** Toggles allowment of stack sizes under 1 and above 64 */
    public ItemUtil toggleUnsafeStackSize() {
     ...
     */
    public ItemUtil toConfig(FileConfiguration cfg, String path) {
        cfg.set(path, build());
        return this;
    }
     ...
     */
    public ItemUtil fromConfig(FileConfiguration cfg, String path) {
        return new ItemUtil(cfg, path);
    }
     ...
     */
    public static void toConfig(FileConfiguration cfg, String path, ItemUtil builder) {
     ...
     * @return The ItemBuilder as JSON String
     */
    public static String toJson(ItemUtil builder) {
     ...
     */
    public static ItemUtil fromJson(String json) {
        return new Gson().fromJson(json, ItemUtil.class);
    }
     ...
     */
    public ItemUtil applyJson(String json, boolean overwrite) {
        ItemUtil b = new Gson().fromJson(json, ItemUtil.class);
        if (overwrite)
            return b;
    ...
    public class Unsafe {
        ...
        /** Do not access using this Field */
        protected final ItemUtil builder;

        /** Initalizes the Unsafe Class with a ItemBuilder */
        public Unsafe(ItemUtil builder) {
